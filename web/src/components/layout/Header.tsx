...
import { Sun, Moon, Monitor, Zap, ChevronDown } from "lucide-react";
...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-(--color-border) bg-(--color-surface)/80 backdrop-blur-xl">
